...
class CartaoModel{
  ...
  Map<String, dynamic> toDatabase() {
    return {
      ...
      'st_deleted': (deletadoFlag != null) ?1:null,
      'dt_deleted':(deletadoFlag != null)? Funcoes.dataAtualEUA(retornarHorario: true).toString() : 0 ,
    };
  }
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'dt_deletado':(deletadoFlag != null)? Funcoes.dataAtualEUA(retornarHorario: true).toString() : null ,
    };
  }
