...
class ContaModel {
  ...
  fetchById(int id) async {
    ...
    if (id != null || id.toString() != "") {
      ...
      linha = linha.isNotEmpty ? await objeto.fromToDatabase(linha.first) : null;
    }
    return linha;
  }
  ...
  fetchByAll() async {
    ...
    for (var linha in linhas) {
      ...
      objeto.cartoes = await objeto.fetchByAllCards( int.parse(objeto.id.toString() ) );
      lista.add(objeto);
    }
    return lista;
  }
  ...
  save() async {
    Map retorno = new Map<String,dynamic>();
    var id;
