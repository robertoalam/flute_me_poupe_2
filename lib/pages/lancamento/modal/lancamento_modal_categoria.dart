...
class _LancamentoModalCategoriaState extends State<LancamentoModalCategoria> {
  ...
  List<CategoriaCadModel> _lista = [];
  List<CategoriaCadModel> _listaFiltrada = [];
  var _listaIcones = Configuracoes.icones;

  @override
  Widget build(BuildContext context) {

    _lista = widget.listaCategoria as List<CategoriaCadModel>;
    ...
    return Container(
      child: ListTile(
        leading: CircleAvatar(
          ...
          child: IconeGambiarra( icone , Colors.black , 22,),
        ),
