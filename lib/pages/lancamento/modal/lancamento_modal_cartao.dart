      ...
      child: Container(
        ...
        child: ListTile(
          leading: CircleAvatar(
              backgroundColor: Color(int.parse( (objeto.conta!.banco!.corSecundaria != null ) 
                ? Funcoes.converterCorStringColor( objeto.conta!.banco!.corSecundaria.toString() ) 
                :  Funcoes.converterCorStringColor( "#FFFFFF" ) ) ),
              child: Padding(
                padding: EdgeInsets.all(5),
                child: Image.asset( objeto.conta!.banco!.imageAsset.toString() ),
              )
          ),
