...
class ModalDialogWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // VARIAVEIS
      // ICONE
    IconData icone = (this.icone != null) 
      ? new IconData( int.parse( this.icone.toString() ) )
      : Icons.check;
    Color iconeColor = (this.iconeColor != null) 
      ? Color( int.parse(this.iconeColor.toString().replaceAll('#', '0xff') ) )
      :Colors.white ;
    Color iconeBackground = (this.iconeBackground != null) 
      ? Theme.of(context).primaryColor 
      : Color( int.parse( this.iconeBackground.toString().replaceAll('#', '0xff') ) ) ;

      // MENSAGEM
    String mensagem = (this.mensagem != null)? this.mensagem.toString() : '';

      // BOTOES
    String botaoTexto = (this.botaoTexto == null)? "OK":this.botaoTexto.toString();
    Color botaoTextoColor = (this.botaoTextoColor != null)
      ? Color( int.parse((this.botaoTextoColor.toString().replaceAll('#', '0xff') ) ) )
      : Colors.white;

    bool botaoCancelar = (this.exibirBotaoCancelar != null) 
    ? this.exibirBotaoCancelar 
    : false;

    Color botaoColor = (this.botaoColor !=null)
      ? Color( int.parse((this.botaoColor.toString().replaceAll('#', '0xff') ) ) )
      : Theme.of(context).primaryColor;
